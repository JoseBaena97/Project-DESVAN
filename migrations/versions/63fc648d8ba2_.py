...
Revision ID: 63fc648d8ba2
Revises: 
Create Date: 2026-06-01 17:13:35.069233
...
def upgrade():
    ...
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('user_id', sa.Integer(), nullable=False),
    sa.Column('type', sa.Enum('reservation_created', 'review_received', 'event_cancelled', 'event_upcoming', name='notificationtype'), nullable=False),
